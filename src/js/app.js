...
function detectDevice() {
	...
	if (window.innerWidth < 600) {
		for (let i = 0; i <= 2; i++) {
			document.querySelectorAll('.auctions-slider .auctions-slide')[i].style.display = 'block';
			document.querySelectorAll('.popular-slider .auctions-slide')[i].style.display = 'block';
